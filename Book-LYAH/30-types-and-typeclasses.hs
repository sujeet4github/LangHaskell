{- https://github.com/noelmarkham/learn-you-a-haskell-exercises/blob/master/3-types-and-typeclasses.hs
 -
...
reverseColourOrder = [maxColor,(pred maxColor) .. firstColour]
    where
        maxColor = maxBound :: Colour
...
{-
 ...
 -}
paintMix c1 c2 = toEnum q :: Colour
                where
                    q = quot ((fromEnum c1) + (fromEnum c2)) 2